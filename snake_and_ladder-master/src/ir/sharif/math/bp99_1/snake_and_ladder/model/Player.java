...
public class Player {
    ...
    public Player(String name, int score, int id, int playerNumber) {
        ...
        this.pieces.add(new Bomber(this));
        this.pieces.add(new Sniper(this));
        this.pieces.add(new Thief(this));
        this.pieces.add(new Healer(this));
        this.moveLeft = 0;
    ...
    public boolean hasMove(Board board, int diceNumber) {
        ...
        for (Piece piece : pieces) {
            for (Cell cell :
                    board.getCells()) {
                if (piece.isValidMove(cell, diceNumber) || piece.canUseAbility()) {
                    x = true;
                }
